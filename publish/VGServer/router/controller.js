...
exports.graphController = function (route, relateCollection, collection) {
  route
    ...
    .post('/', async (ctx, next) => { // post操作忽略参数中的ID
...
function strMod (str, radix = 16, bucket = 30) {
  return parseInt(str, radix) % bucket
}
